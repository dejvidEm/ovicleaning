    ...
    >
      <div className="container mx-auto px-4 relative">
        <div className="flex items-center justify-between h-20 relative z-10">
          <a href="#home" className="text-2xl font-bold text-primary cursor-pointer relative z-20">
          ...
          {/* Mobile Menu Button */}
          <Button variant="ghost" size="icon" className="md:hidden text-foreground relative z-20" onClick={() => setIsOpen(!isOpen)}>
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden pb-4 pt-4 animate-in slide-in-from-top duration-300 bg-background/95 backdrop-blur-md -mx-4 px-4 relative z-0">
